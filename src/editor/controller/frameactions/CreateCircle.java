...
public class CreateCircle extends AbstractAction {
	PFStateManager pfsm;
	public CreateCircle(PFStateManager pfsm, ResourceManager rm) {
		this.pfsm = pfsm;
		String shortDesc = "Create Circle";
		
		putValue(LARGE_ICON_KEY, rm.getIcon(ICONS.CIRCLE));
