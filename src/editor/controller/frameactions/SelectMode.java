...
public class SelectMode extends AbstractAction {
	PFStateManager pfsm;
	public SelectMode(PFStateManager pfsm, ResourceManager rm) {
		this.pfsm = pfsm;
		String shortDesc = "Select mode";
		
		putValue(LARGE_ICON_KEY, rm.getIcon(ICONS.SELECT));
