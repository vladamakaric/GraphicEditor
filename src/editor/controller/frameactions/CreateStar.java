...
public class CreateStar extends AbstractAction {
	PFStateManager pfsm;
	public CreateStar(PFStateManager pfsm, ResourceManager rm) {
		this.pfsm = pfsm;
		String shortDesc = "Create Star";
		
		putValue(LARGE_ICON_KEY, rm.getIcon(ICONS.STAR));
