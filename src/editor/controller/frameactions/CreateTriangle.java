...
public class CreateTriangle extends AbstractAction {
	PFStateManager pfsm;
	public CreateTriangle(PFStateManager pfsm, ResourceManager rm) {
		this.pfsm = pfsm;
		String shortDesc = "Create Triangle";
		
		putValue(LARGE_ICON_KEY, rm.getIcon(ICONS.TRIANGLE));
