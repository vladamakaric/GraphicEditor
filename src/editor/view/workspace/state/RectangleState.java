...
public class RectangleState extends PFrameState {
	
	PFStateManager sm;
	FrameController fc;
	PFrameView pfv;
	public RectangleState(PFStateManager sm, FrameController fc,PFrameView pfv ){
		this.sm = sm;
		this.fc = fc;
		this.pfv = pfv;
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		fc.createNewGElement(Type.RECTANGLE, position.x, position.y);
	}
